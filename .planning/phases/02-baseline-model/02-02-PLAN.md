...
<objective>
Migrate the autoencoder architecture (Encoder, Decoder, Autoencoder wrapper) from the tested notebook implementation to source files.

Source: learningnotebooks/phase4_sar_codec/day2_no_references.ipynb (Cells 7, 13, 16)

Purpose: The notebook contains working, tested implementations of SAREncoder, SARDecoder, and SARAutoencoder. These need to be moved to the proper source files while preserving existing docstrings and type hints.
...
<task type="auto">
  <name>Task 1: Migrate SAREncoder from notebook</name>
  <files>src/models/encoder.py</files>
  <action>
Migrate SAREncoder class from day2_no_references.ipynb (Cell 7) to encoder.py, replacing NotImplementedError stubs.
...
<task type="auto">
  <name>Task 2: Migrate SARDecoder from notebook</name>
  <files>src/models/decoder.py</files>
  <action>
Migrate SARDecoder class from day2_no_references.ipynb (Cell 13) to decoder.py, replacing NotImplementedError stubs.
...
<task type="auto">
  <name>Task 3: Migrate SARAutoencoder from notebook</name>
  <files>src/models/autoencoder.py</files>
  <action>
Migrate SARAutoencoder class from day2_no_references.ipynb (Cell 16) to autoencoder.py, replacing NotImplementedError stubs.
